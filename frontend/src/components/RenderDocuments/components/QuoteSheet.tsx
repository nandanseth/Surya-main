...
function QuoteSheet({ policy }) {
    ...
    const StateTax = (premium) => {
        ...
        console.log(policy.policy.values.states, 'ling')
        ...
        <Document>
            ...
            <Page style={styles.body}>
                    ...
                    <View>
                        ...
                        <View style={[styles.row]}>
                            <Text style={[styles.cell]}></Text>
                            <Text style={[styles.cellBoldSmall]}>Policy Issuance Fee (Non-refundable)</Text>
                            <Text style={[styles.cell]}></Text>
                            <Text style={[styles.cell]}>-</Text>
                            <Text style={[styles.cellBoldSmall]}>
                                ${value}
            ...
            {policy.vehicles.values.map((value, index) => (
                ...
                <Page style={styles.body}>
                    <View>
                        ...
                        {(policy.coverage.values.pedPipSingleLimit !== 'No') ? (
                            <View style={[styles.row]}>
                                <Text style={[styles.cell]}>
                                    {indexFormula({ index })}
                                </Text>
            ...
            <Page style={styles.body}>
                ...
                <View style={[styles.row]}>
                    <Text style={[styles.cellBold]}>Policy Issuance Fee</Text>
