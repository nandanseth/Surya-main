...
function DeletedDriver({ policy, keyOne, oldValue, newValue, endDate, endNumber}) {
    ...
    const getUniqueValues = () => {
        ...
        for (const i in myArray) {
            driverList.push(policy.drivers.values[myArray[i].match(/\d+/)]);
        }
    ...
    const getBaseDates = () => {
        ...
        const baseEffDate = array[0].driverEffDate
        const baseExpDate = array[0].driverExpDate
        ...
        <Document>
            <Page style={styles.body}>
                <View>
                    ...
                    {getUniqueValues().map((driver, index) => {
                        return (
