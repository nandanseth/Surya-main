...
function BrokerInvoice({ policy, index, installmentDate, installmentAmount, piFeeAmount, subAmount, taxAmount, feeAmount, totalAmount, additionalCharges }) {
    ...
    const brokerToId = {
        ...
        "Cluett Commercial Insurance Agency Inc.": "CLUTBRK",
        "Quantum Risk Solutions": "QRSBRK",
        "American Business Insurance": "ABIBRK",
        "Transportation Insurance Placement Services": "TIPSBRK",
        "Big Rigs": "BRBRK",
        "Cluett Insurance Agency": "CLUETTBRK",
        "Cornell Insurance Agency": "CORNBRK",
        "Laguna Pacific Insurance Services": "LPISBRK"
        }
            ...
            <Page style={styles.body}>
                <View>
                        ...
                        <View style={[styles.row]} wrap={false}>
                            ...
                            <Text style={[styles.cellRomanTwo]}>
                                $ {policy.policy.agent.includes("CLU") ? (
                                <>{(0.12*installmentAmount).toFixed(2)}</>
                                ) : policy.policy.agent.includes("Q") ? (
                                <>{(0.15*installmentAmount).toFixed(2)}</>
                                ) : (
                                <>{(0.1*installmentAmount).toFixed(2)}</>
                                )}
                            </Text>
                        </View> 
                        <View style={[styles.space]} wrap={false}>
