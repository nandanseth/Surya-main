...
function DriverEndorsement({ policy, key, oldValue, newValue, endDate}) {
            ...
            <Page style={styles.body}>
                <View>
                    ...
                    <Text style={styles.boldTextSmall}>
                        ...
                        {'\n'} {'\n'}
                        ENDORSEMENT EFFECTIVE: <Text style={styles.textSmall}>{driverEffDate}</Text>
                        {'\n'} {'\n'} {'\n'}
                    </Text>
...
export default DriverEndorsement
