...
const { limitOptions, autoSymbolOptions, bodyPerPersonOptions, bodyPerAccidentOptions, propertyDamageOptions } =
  CoverageOptions;
  ...
  return (
    <div>
      <Section>
        ...
        {overall === 'Combined Single Limit' ? combinedSection : splitSection}
        <Flex>
          <SuryaInput
      ...
      <Section>
        ...
        <Flex>{personalInjury === 'Combined Single Limit' ? pIProtectionSingle : pIProtectionSplit}</Flex>
      ...
      <Section>
        ...
        <Flex>{medicalPayments === 'Combined Single Limit' ? medicalSingle : medicalSplit}</Flex>
        <Flex>
          <SuryaInput
      ...
      <Section>
        ...
        <Flex>
          {underinsuredMotorist === 'Combined Single Limit' ? underinsuredMotoristSingle : underinsuredMotoristSplit}
        </Flex>
      ...
      <Section>
        ...
        <Flex>{uninsuredMotorist === 'Combined Single Limit' ? uninsuredMotoristSingle : uninsuredMotoristSplit}</Flex>
