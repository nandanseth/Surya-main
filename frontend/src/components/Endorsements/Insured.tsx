...
const Insured = ({ insured, setInsured, policy }) => {
    const values = insured
    const setValues = setInsured
    ...
    useEffect(()=> {
        ...
        const getAddInsured = async() => {
            ...
            const Application = (Moralis as any).Object.extend("Policies")

            const query = new (Moralis as any).Query(Application);
            const data = await query.equalTo("policyNum", policy.policyNum).first();
    ...
    const handleInputOnChange = (e) => {
        ...
        console.log(insured, 'handleInputOnChange')
    }
