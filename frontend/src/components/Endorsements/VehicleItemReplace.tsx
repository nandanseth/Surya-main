...
const VehicleItem = ({
    ...
    //         copy[num]["overallPremium"] = coverageValues.overallPremium
    //         copy[num]["personalInjuryProtectionPremium"] = coverageValues.personalInjuryProtectionPremium
    //         copy[num]["pedPipProtectionPremium"] = coverageValues.pedPipProtectionPremium
    //         copy[num]["medicalPaymentsPremium"] = coverageValues.medicalPaymentsPremium
    //         copy[num]["underinsuredMotoristPremium"] = coverageValues.underinsuredMotoristPremium
    //         copy[num]["uninsuredMotoristPremium"] = coverageValues.uninsuredMotoristPremium
