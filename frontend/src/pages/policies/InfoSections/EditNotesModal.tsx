...
const NotesModal = ({notesList, policyNum, setEditNotesModal, editedNote, index}) => {
    const [noteDate, setNoteDate] = useState(editedNote.Date)
    ...
    return (
        <Modal>
            <XButton onClick={()=>setEditNotesModal(false)}>X</XButton>
            <Severity name="severity" id="severity" defaultValue={editedNote.Severity} onChange={(e) => setSeverity(e.target.value)}>
                <option value="low">Low</option>
                <option value="medium">Medium</option>
                <option value="high">High</option>
            </Severity>
            <Date value={noteDate} placeholder="Date" defaultValue={editedNote.Date} onChange={(e) => setNoteDate(e.target.value)}/>
            
            <NotesBox defaultValue={editedNote.Note} onChange={(e)=>setFullNote(e.target.value)}>
