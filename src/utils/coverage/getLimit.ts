export const limits = ['35,000', '50,000', '100,000', '250,000', '300,000', '350,000', '500,000', '1,000,000', '2,000,000', '3,000,000'];

export const limitsSelectMap = limits.map((item) => ({ value: item, label: item }));
...
export const deductable = ['250', '500', '1,000', '2,500', '5,000', '10,000', '25,000', '50,000', '75,000', '100,000', 'N/A', 'Excluded'];

export const autoSymbol = [
  '250', '500', '1,000', '2,500', '5,000', '10,000', '25,000', '50,000', '75,000', '100,000', 'N/A', 'Included',
];
...
export const bodyPerAccident = [
  '25,000', '50,000', '100,000', '300,000',
];

export const bodyPerPerson = [
